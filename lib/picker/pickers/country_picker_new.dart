...
import 'package:atlas_picker/picker/elements/picker_helper.dart';
...
class CountryPickerNew extends HookWidget {
  ...
  const CountryPickerNew({super.key, required this.pickerType, this.searchBoarderColor, required this.onChanged, this.customWidget, this.verticalPadding, this.horizontalPadding, this.isSearchEnable = true});

  @override
  Widget build(BuildContext context) {
    final filteredCountries = useState<List<CountryModel>>(ListOfCountries.listOfCountries);
    ...
    void searchCountries(String value) {
      ...
      if (value.isEmpty) {
        ...
        filteredCountries.value = ListOfCountries.listOfCountries.where((country) => (country.name).toLowerCase().contains(value.toLowerCase()) || (country.code).toLowerCase().contains(value.toLowerCase())).toList();
      }
    }
